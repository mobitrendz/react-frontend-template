      ...
      <form onSubmit={onSubmit} className="p-8 space-y-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="space-y-2">
            <label htmlFor="full-name" className="text-sm font-bold text-[var(--text-h)] flex items-center gap-2">
          ...
          <div className="space-y-2">
            <label htmlFor="admin-email" className="text-sm font-bold text-[var(--text-h)] flex items-center gap-2">
        ...
        <div className="space-y-2">
          <label htmlFor="admin-password" className="text-sm font-bold text-[var(--text-h)] flex items-center gap-2">
        ...
        <div className="flex justify-end gap-4 pt-2">
          ...
          >
            {isSubmitting ? 'Provisioning...' : (isSuper ? 'Create Admin Account' : 'Create User Account')}
          </button>
        </div>
      </form>
    </div>
