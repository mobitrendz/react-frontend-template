      ...
      return (
        <div className="min-h-screen flex items-center justify-center bg-slate-950 p-6">
          <div className="max-w-xl w-full bg-slate-900 border border-red-500/20 rounded-[32px] p-12 text-center shadow-2xl">
            ...
            <h1 className="text-3xl font-black text-white tracking-tight mb-4">Application Crash</h1>
            <p className="text-slate-400 text-lg mb-8 font-medium">
              Something went wrong in the dashboard. Please try refreshing or contact support.
            </p>
