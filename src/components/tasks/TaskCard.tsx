      ...
      <div className="flex items-start gap-4">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex flex-wrap gap-3 mt-4">
            <span
              className={`text-[10px] px-2 py-0.5 rounded-md uppercase font-black tracking-widest border ${priorityColors[todo.priority || "medium"]}`}
            >
              {todo.priority}
            </span>
            ...
            <div
              className={`flex items-center gap-1.5 text-[10px] font-bold uppercase tracking-wider ${isCompleted ? "text-green-500" : "text-blue-500"}`}
            >
              <div
